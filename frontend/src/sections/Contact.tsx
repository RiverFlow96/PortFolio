            ...
            <div className="flex flex-col gap-4">
              {socials.map((social) => (
                ...
                >
                  ...
                  <span className="text-gray-300 font-mono">{social.label}</span>
              ...
              <button
                ...
                className={`
                  ...
                  ${status === 'success' 
                    ...
                    : 'bg-gradient-to-r from-cyan-500 to-pink-500 hover:from-cyan-600 hover:to-pink-600 text-white hover:shadow-lg hover:shadow-cyan-500/25'
                  }
