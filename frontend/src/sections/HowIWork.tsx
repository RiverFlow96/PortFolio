  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        {/* Principles */}
        <div className={`
          mt-20 p-8 bg-gradient-to-r from-cyan-500/5 to-cyan-600/5 border border-cyan-500/10 rounded-2xl
        ...
        `}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div>
              <p className="font-mono text-cyan-400 text-sm mb-2">CLEAN CODE</p>
