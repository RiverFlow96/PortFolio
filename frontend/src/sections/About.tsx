...
export function About(): JSX.Element {
  ...
  const colorMap = {
    ...
    pink: "from-pink-500/10 to-transparent hover:from-pink-500/20 border-pink-500/20 hover:border-pink-500/40",
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="relative inline-block">
              <div className="relative w-40 h-40 rounded-2xl p-[2px] bg-gradient-to-br from-cyan-500 via-pink-500 to-emerald-500">
