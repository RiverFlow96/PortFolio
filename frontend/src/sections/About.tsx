    ...
    >
      ...
      <div className="container-main relative z-10">
        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-16 lg:gap-24">
          ...
          >
            <div className="relative group">
              ...
              <div className="relative w-full aspect-square rounded-3xl overflow-hidden border border-[var(--border)]">
                <img
                  src={
                    profile.avatar || `https://github.com/${profile.name}.png`
                  }
          ...
          <div
            className={`space-y-10 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}
          >
            ...
            <div className="p-6 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border)]">
              <div className="flex items-center gap-3 mb-5 pb-4 border-b border-[var(--border)]">
                ...
                <span className="text-[var(--text-muted)] text-xs ml-2 font-mono">
                  philosophy.ts
                </span>
              </div>
              <div className="space-y-3">
                {philosophy.map(
                  (item: { icon: string; text: string }, i: number) => (
                    <div
                      key={i}
